...
left_clicks = middle_clicks = right_clicks = 0
...
def is_game_over(board):
    ...
    return board.all_bombs_marked


def finalize():
    print(f"all bombs marked")
    print(f"{left_clicks=}")
    print(f"{middle_clicks=}")
    print(f"{right_clicks=}")
    exit(2)
